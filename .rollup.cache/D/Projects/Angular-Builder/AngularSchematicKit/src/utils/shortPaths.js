...
exports.makeExportPath =
  exports.addExportsToNearestIndex =
  exports.findShortPath =
  exports.findStructureWithShortPath =
  exports.addShortPath =
  exports.addExportToIndexFile =
  exports.createIndexFile =
    void 0;
...
function addExportsToNearestIndex(options, structure, type) {
  return async (tree) => {
    ...
    const bootstrapModulePath = (0, file_utils_1.getMainModulePath)(
      tree,
      clientBuildTarget,
      project?.sourceRoot || '',
      structure.parent
    ...
    const foundStructure = findStructureWithShortPath(
      structure,
      (0, paths_1.getModuleNameFromPath)(bootstrapModulePath)
    );
